...
const Profile = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-[2rem] lg:w-screen-md  mx-auto py-[2rem]">
      <div className="bg-[#efefef] w-full py-[3rem] rounded-lg">
        <h3 className="font-bold text-center translate-x-[50%] w-fit uppercase text-[#374151]">
          Profile details
        </h3>
          ...
          >
            <div className="flex flex-col gap-3 relative">
              ...
              <input
                ...
                className="text-[2rem] w-full rounded-lg px-[1.5rem] py-[0.5rem]"
      ...
      {user?.admin ? (
        <div className="w-full flex flex-col gap-[3rem] justify-center rounded-lg bg-[#efefef] py-[3rem]">
          <h3 className="font-bold text-center uppercase text-[#374151]">
            Change Password
          </h3>
